...
000000008000008c <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    8000009a:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdb69f>
...
consoleinit(void)
{
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    8000047c:	b5078793          	addi	a5,a5,-1200 # 80021fc8 <devsw>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000a00:	76478793          	addi	a5,a5,1892 # 80023160 <end>
...
0000000080000aaa <kinit>:
{
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80000ad2:	69250513          	addi	a0,a0,1682 # 80023160 <end>
...
0000000080000d2e <memmove>:
    ...
    80000d46:	0705                	addi	a4,a4,1 # fffffffffffff001 <end+0xffffffff7ffdbea1>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  for(int level = 2; level > 0; level--) {
    80001016:	3a5d                	addiw	s4,s4,-9 # ffffffffffffeff7 <end+0xffffffff7ffdbe97>
    ...
    80001786:	c2dd                	beqz	a3,8000182c <copyinstr+0xa6>
{
  ...
  while(got_null == 0 && max > 0){
    ...
    8000180c:	00074703          	lbu	a4,0(a4) # fffffffffffff000 <end+0xffffffff7ffdbea0>
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000186a:	51aa0a13          	addi	s4,s4,1306 # 80017d80 <tickslock>
    char *pa = kalloc();
...
procinit(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001936:	44e98993          	addi	s3,s3,1102 # 80017d80 <tickslock>
      initlock(&p->lock, "proc");
...
0000000080001bb6 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001bce:	1b690913          	addi	s2,s2,438 # 80017d80 <tickslock>
    acquire(&p->lock);
...
0000000080001ea2 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    for(p = proc; p < &proc[NPROC]; p++) {
    80001ee6:	00016917          	auipc	s2,0x16
    80001eea:	e9a90913          	addi	s2,s2,-358 # 80017d80 <tickslock>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    for(p = proc; p < &proc[NPROC]; p++) {
    80001f0e:	1b848493          	addi	s1,s1,440
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    800020d8:	00016917          	auipc	s2,0x16
    800020dc:	ca890913          	addi	s2,s2,-856 # 80017d80 <tickslock>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    800020ec:	1b848493          	addi	s1,s1,440
...
000000008000212e <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    80002154:	c3098993          	addi	s3,s3,-976 # 80017d80 <tickslock>
    80002158:	a029                	j	80002162 <reparent+0x34>
    8000215a:	1b848493          	addi	s1,s1,440
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80002276:	00016997          	auipc	s3,0x16
    8000227a:	b0a98993          	addi	s3,s3,-1270 # 80017d80 <tickslock>
    acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    80002298:	1b848493          	addi	s1,s1,440
...
000000008000232e <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    for(pp = proc; pp < &proc[NPROC]; pp++){
    80002368:	00016997          	auipc	s3,0x16
    8000236c:	a1898993          	addi	s3,s3,-1512 # 80017d80 <tickslock>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80002536:	00016917          	auipc	s2,0x16
    8000253a:	9a290913          	addi	s2,s2,-1630 # 80017ed8 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    8000257a:	1b848493          	addi	s1,s1,440
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80002636:	74e50513          	addi	a0,a0,1870 # 80017d80 <tickslock>
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80002706:	67e48493          	addi	s1,s1,1662 # 80017d80 <tickslock>
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    80002c90:	0f450513          	addi	a0,a0,244 # 80017d80 <tickslock>
  ...
  while(ticks - ticks0 < n){
    ...
    80002caa:	00015997          	auipc	s3,0x15
    80002cae:	0d698993          	addi	s3,s3,214 # 80017d80 <tickslock>
  ...
  release(&tickslock);
    ...
    80002cea:	09a50513          	addi	a0,a0,154 # 80017d80 <tickslock>
  ...
  return 0;
    ...
    80002d0a:	07a50513          	addi	a0,a0,122 # 80017d80 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002d52:	03250513          	addi	a0,a0,50 # 80017d80 <tickslock>
  ...
  release(&tickslock);
    ...
    80002d6a:	01a50513          	addi	a0,a0,26 # 80017d80 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002da2:	ffa50513          	addi	a0,a0,-6 # 80017d98 <bcache>
    80002da6:	ffffe097          	auipc	ra,0xffffe
    80002daa:	da0080e7          	jalr	-608(ra) # 80000b46 <initlock>

  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
    80002dae:	0001d797          	auipc	a5,0x1d
    80002db2:	fea78793          	addi	a5,a5,-22 # 8001fd98 <bcache+0x8000>
    80002db6:	0001d717          	auipc	a4,0x1d
    80002dba:	24a70713          	addi	a4,a4,586 # 80020000 <bcache+0x8268>
    80002dbe:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002dc2:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002dc6:	00015497          	auipc	s1,0x15
    80002dca:	fea48493          	addi	s1,s1,-22 # 80017db0 <bcache+0x18>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002e2a:	f7250513          	addi	a0,a0,-142 # 80017d98 <bcache>
    80002e2e:	ffffe097          	auipc	ra,0xffffe
    80002e32:	da8080e7          	jalr	-600(ra) # 80000bd6 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80002e36:	0001d497          	auipc	s1,0x1d
    80002e3a:	21a4b483          	ld	s1,538(s1) # 80020050 <bcache+0x82b8>
    80002e3e:	0001d797          	auipc	a5,0x1d
    80002e42:	1c278793          	addi	a5,a5,450 # 80020000 <bcache+0x8268>
    ...
    80002e6a:	f3250513          	addi	a0,a0,-206 # 80017d98 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    80002e84:	0001d497          	auipc	s1,0x1d
    80002e88:	1c44b483          	ld	s1,452(s1) # 80020048 <bcache+0x82b0>
    80002e8c:	0001d797          	auipc	a5,0x1d
    80002e90:	17478793          	addi	a5,a5,372 # 80020000 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002ec8:	ed450513          	addi	a0,a0,-300 # 80017d98 <bcache>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002f70:	e2c50513          	addi	a0,a0,-468 # 80017d98 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    b->next = bcache.head.next;
    80002f94:	0001d797          	auipc	a5,0x1d
    80002f98:	e0478793          	addi	a5,a5,-508 # 8001fd98 <bcache+0x8000>
    80002f9c:	2b87b703          	ld	a4,696(a5)
    80002fa0:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002fa2:	0001d717          	auipc	a4,0x1d
    80002fa6:	05e70713          	addi	a4,a4,94 # 80020000 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002fba:	de250513          	addi	a0,a0,-542 # 80017d98 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002ff2:	daa50513          	addi	a0,a0,-598 # 80017d98 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003008:	d9450513          	addi	a0,a0,-620 # 80017d98 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000302e:	d6e50513          	addi	a0,a0,-658 # 80017d98 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003044:	d5850513          	addi	a0,a0,-680 # 80017d98 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80003070:	4087a783          	lw	a5,1032(a5) # 80020474 <sb+0x1c>
...
00000000800030d6 <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    800030f4:	36c7a783          	lw	a5,876(a5) # 8002045c <sb+0x4>
    800030f8:	cff5                	beqz	a5,800031f4 <balloc+0x11e>
    800030fa:	8baa                	mv	s7,a0
    800030fc:	4a81                	li	s5,0
    bp = bread(dev, BBLOCK(b, sb));
    800030fe:	0001db17          	auipc	s6,0x1d
    80003102:	35ab0b13          	addi	s6,s6,858 # 80020458 <sb>
...
00000000800032f2 <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    8000330a:	17250513          	addi	a0,a0,370 # 80020478 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    8000331c:	17848493          	addi	s1,s1,376 # 80020490 <itable+0x18>
    80003320:	0001f697          	auipc	a3,0x1f
    80003324:	c0068693          	addi	a3,a3,-1024 # 80021f20 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003350:	12c50513          	addi	a0,a0,300 # 80020478 <itable>
  ...
  release(&itable.lock);
    ...
    80003380:	0fc50513          	addi	a0,a0,252 # 80020478 <itable>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    800033ca:	0001d997          	auipc	s3,0x1d
    800033ce:	08e98993          	addi	s3,s3,142 # 80020458 <sb>
  ...
  initlog(dev, &sb);
    800033fe:	0001d597          	auipc	a1,0x1d
    80003402:	05a58593          	addi	a1,a1,90 # 80020458 <sb>
...
000000008000342e <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003448:	03450513          	addi	a0,a0,52 # 80020478 <itable>
    8000344c:	ffffd097          	auipc	ra,0xffffd
    80003450:	6fa080e7          	jalr	1786(ra) # 80000b46 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003454:	0001d497          	auipc	s1,0x1d
    80003458:	04c48493          	addi	s1,s1,76 # 800204a0 <itable+0x28>
    8000345c:	0001f997          	auipc	s3,0x1f
    80003460:	ad498993          	addi	s3,s3,-1324 # 80021f30 <log+0x10>
...
000000008000348e <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    800034a4:	0001d717          	auipc	a4,0x1d
    800034a8:	fc072703          	lw	a4,-64(a4) # 80020464 <sb+0xc>
    ...
    800034b8:	0001da17          	auipc	s4,0x1d
    800034bc:	fa0a0a13          	addi	s4,s4,-96 # 80020458 <sb>
...
0000000080003560 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003578:	efc5a583          	lw	a1,-260(a1) # 80020470 <sb+0x18>
...
00000000800035ee <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    800035fe:	e7e50513          	addi	a0,a0,-386 # 80020478 <itable>
  ...
  release(&itable.lock);
    ...
    80003614:	e6850513          	addi	a0,a0,-408 # 80020478 <itable>
...
000000008000362c <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80003676:	dfe5a583          	lw	a1,-514(a1) # 80020470 <sb+0x18>
...
00000000800037e6 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    800037f8:	c8450513          	addi	a0,a0,-892 # 80020478 <itable>
  ...
  release(&itable.lock);
    80003812:	0001d517          	auipc	a0,0x1d
    80003816:	c6650513          	addi	a0,a0,-922 # 80020478 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    8000384a:	c3250513          	addi	a0,a0,-974 # 80020478 <itable>
    ...
    80003880:	bfc50513          	addi	a0,a0,-1028 # 80020478 <itable>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    80003e1e:	0001e917          	auipc	s2,0x1e
    80003e22:	10290913          	addi	s2,s2,258 # 80021f20 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003e42:	0001e797          	auipc	a5,0x1e
    80003e46:	10e78793          	addi	a5,a5,270 # 80021f50 <log+0x30>
    ...
    80003e58:	0001e617          	auipc	a2,0x1e
    80003e5c:	0fc60613          	addi	a2,a2,252 # 80021f54 <log+0x34>
...
0000000080003e8e <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003e92:	0be7a783          	lw	a5,190(a5) # 80021f4c <log+0x2c>
    80003e96:	0af05d63          	blez	a5,80003f50 <install_trans+0xc2>
{
    ...
    80003eb0:	0001ea97          	auipc	s5,0x1e
    80003eb4:	0a0a8a93          	addi	s5,s5,160 # 80021f50 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003eb8:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003eba:	0001e997          	auipc	s3,0x1e
    80003ebe:	06698993          	addi	s3,s3,102 # 80021f20 <log>
...
0000000080003f52 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    80003f64:	0001e497          	auipc	s1,0x1e
    80003f68:	fbc48493          	addi	s1,s1,-68 # 80021f20 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003fa4:	0001e717          	auipc	a4,0x1e
    80003fa8:	fac70713          	addi	a4,a4,-84 # 80021f50 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80003fde:	f607a923          	sw	zero,-142(a5) # 80021f4c <log+0x2c>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80004008:	f1c50513          	addi	a0,a0,-228 # 80021f20 <log>
    8000400c:	ffffd097          	auipc	ra,0xffffd
    80004010:	bca080e7          	jalr	-1078(ra) # 80000bd6 <acquire>
  while(1){
    if(log.committing){
    80004014:	0001e497          	auipc	s1,0x1e
    80004018:	f0c48493          	addi	s1,s1,-244 # 80021f20 <log>
      sleep(&log, &log.lock);
    ...
    8000405c:	ec850513          	addi	a0,a0,-312 # 80021f20 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    80004088:	0001e497          	auipc	s1,0x1e
    8000408c:	e9848493          	addi	s1,s1,-360 # 80021f20 <log>
  ...
  if(log.outstanding == 0){
    ...
    do_commit = 1;
    log.committing = 1;
    800040ac:	0001e497          	auipc	s1,0x1e
    800040b0:	e7448493          	addi	s1,s1,-396 # 80021f20 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800040cc:	e5848493          	addi	s1,s1,-424 # 80021f20 <log>
    ...
    80004108:	e1c48493          	addi	s1,s1,-484 # 80021f20 <log>
  ...
  release(&log.lock);
    ...
    80004130:	8082                	ret
  for (tail = 0; tail < log.lh.n; tail++) {
    80004132:	0001ea97          	auipc	s5,0x1e
    80004136:	e1ea8a93          	addi	s5,s5,-482 # 80021f50 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    8000413a:	0001ea17          	auipc	s4,0x1e
    8000413e:	de6a0a13          	addi	s4,s4,-538 # 80021f20 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    log.lh.n = 0;
    800041bc:	0001e797          	auipc	a5,0x1e
    800041c0:	d807a823          	sw	zero,-624(a5) # 80021f4c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800041e0:	d4490913          	addi	s2,s2,-700 # 80021f20 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000421a:	0001e717          	auipc	a4,0x1e
    8000421e:	d3670713          	addi	a4,a4,-714 # 80021f50 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004236:	0001e797          	auipc	a5,0x1e
    8000423a:	cea78793          	addi	a5,a5,-790 # 80021f20 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    log.lh.n++;
    8000424e:	0001e717          	auipc	a4,0x1e
    80004252:	cd270713          	addi	a4,a4,-814 # 80021f20 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004284:	0001e717          	auipc	a4,0x1e
    80004288:	c9c70713          	addi	a4,a4,-868 # 80021f20 <log>
  ...
  release(&log.lock);
    ...
    8000429a:	c8a50513          	addi	a0,a0,-886 # 80021f20 <log>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800043ec:	0001e517          	auipc	a0,0x1e
    800043f0:	c7c50513          	addi	a0,a0,-900 # 80022068 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    80004412:	c5a50513          	addi	a0,a0,-934 # 80022068 <ftable>
    80004416:	ffffc097          	auipc	ra,0xffffc
    8000441a:	7c0080e7          	jalr	1984(ra) # 80000bd6 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    8000441e:	0001e497          	auipc	s1,0x1e
    80004422:	c6248493          	addi	s1,s1,-926 # 80022080 <ftable+0x18>
    80004426:	0001f717          	auipc	a4,0x1f
    8000442a:	bfa70713          	addi	a4,a4,-1030 # 80023020 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    8000443a:	0001e517          	auipc	a0,0x1e
    8000443e:	c2e50513          	addi	a0,a0,-978 # 80022068 <ftable>
  ...
  return 0;
    ...
    80004456:	c1650513          	addi	a0,a0,-1002 # 80022068 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    8000447a:	0001e517          	auipc	a0,0x1e
    8000447e:	bee50513          	addi	a0,a0,-1042 # 80022068 <ftable>
  ...
  release(&ftable.lock);
    80004494:	0001e517          	auipc	a0,0x1e
    80004498:	bd450513          	addi	a0,a0,-1068 # 80022068 <ftable>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800044d8:	b9450513          	addi	a0,a0,-1132 # 80022068 <ftable>
  ...
  release(&ftable.lock);
    8000450e:	0001e517          	auipc	a0,0x1e
    80004512:	b5a50513          	addi	a0,a0,-1190 # 80022068 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    8000455c:	b1050513          	addi	a0,a0,-1264 # 80022068 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    8000468e:	93e70713          	addi	a4,a4,-1730 # 80021fc8 <devsw>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    8000472e:	89e70713          	addi	a4,a4,-1890 # 80021fc8 <devsw>
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    ...
    80004f2a:	01a70793          	addi	a5,a4,26 # fffffffffffff01a <end+0xffffffff7ffdbeba>
...
create(char *path, short type, short major, short minor)
{
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    80005000:	044ad783          	lhu	a5,68(s5) # fffffffffffff044 <end+0xffffffff7ffdbee4>
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    80005c78:	3ac78793          	addi	a5,a5,940 # 80023020 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    80005c88:	0001d797          	auipc	a5,0x1d
    80005c8c:	39878793          	addi	a5,a5,920 # 80023020 <disk>
  ...
  wakeup(&disk.free[0]);
    80005cb0:	0001d517          	auipc	a0,0x1d
    80005cb4:	38850513          	addi	a0,a0,904 # 80023038 <disk+0x18>
...
0000000080005ce8 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005d00:	44c50513          	addi	a0,a0,1100 # 80023148 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_DRIVER_FEATURES) = features;
    ...
    80005d64:	75f68693          	addi	a3,a3,1887 # ffffffffc7ffe75f <end+0xffffffff47fdb5ff>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    80005da6:	0001d497          	auipc	s1,0x1d
    80005daa:	27a48493          	addi	s1,s1,634 # 80023020 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    80005dce:	25e73703          	ld	a4,606(a4) # 80023028 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    80005de2:	0001d497          	auipc	s1,0x1d
    80005de6:	23e48493          	addi	s1,s1,574 # 80023020 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005f06:	24650513          	addi	a0,a0,582 # 80023148 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    80005f14:	44a1                	li	s1,8
      disk.free[i] = 0;
    80005f16:	0001db97          	auipc	s7,0x1d
    80005f1a:	10ab8b93          	addi	s7,s7,266 # 80023020 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    80005f20:	0001dc97          	auipc	s9,0x1d
    80005f24:	228c8c93          	addi	s9,s9,552 # 80023148 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005f46:	0de70713          	addi	a4,a4,222 # 80023020 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005f7a:	0001d517          	auipc	a0,0x1d
    80005f7e:	0be50513          	addi	a0,a0,190 # 80023038 <disk+0x18>
    ...
    80005f8a:	f8040a13          	addi	s4,s0,-128
{
  ...
  if(write)
    ...
    80005fa2:	08278793          	addi	a5,a5,130 # 80023020 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80006078:	0d490913          	addi	s2,s2,212 # 80023148 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    800060a4:	f8078793          	addi	a5,a5,-128 # 80023020 <disk>
    800060a8:	97ba                	add	a5,a5,a4
    800060aa:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    800060ae:	0001d997          	auipc	s3,0x1d
    800060b2:	f7298993          	addi	s3,s3,-142 # 80023020 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    800060da:	07250513          	addi	a0,a0,114 # 80023148 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    8000610e:	0001d497          	auipc	s1,0x1d
    80006112:	f1248493          	addi	s1,s1,-238 # 80023020 <disk>
    80006116:	0001d517          	auipc	a0,0x1d
    8000611a:	03250513          	addi	a0,a0,50 # 80023148 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80006192:	fba50513          	addi	a0,a0,-70 # 80023148 <disk+0x128>
